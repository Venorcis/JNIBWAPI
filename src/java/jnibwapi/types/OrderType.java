...
public class OrderType {
	...
	public static class OrderTypes {
		...
		// public static final OrderType ReaverStop = new OrderType(7); //
		// Unused
		...
		// public static final OrderType AttackFixedRange = new OrderType(11);
		// // Unused
		...
		// public static final OrderType StayInRange = new OrderType(21); //
		// Unused
		// public static final OrderType TurretAttack = new OrderType(22); //
		// Unused
		public static final OrderType Nothing = new OrderType(23);
		public static final OrderType Nothing3 = new OrderType(24);
		// public static final OrderType DroneStartBuild = new OrderType(25); //
		// Unused
		// public static final OrderType DroneBuild = new OrderType(26); //
		// Unused
		...
		// public static final OrderType RepairMove = new OrderType(35); //
		// Unused
		...
		// public static final OrderType ZergUnitMorph2 = new OrderType(48); //
		// Unused
		...
		// public static final OrderType CarrierStop = new OrderType(52); //
		// Unused
		...
		// public static final OrderType CarrierFight = new OrderType(56); //
		// Unused
		...
		// public static final OrderType ReaverFight = new OrderType(61); //
		// Unused
		// public static final OrderType ReaverHoldPosition = new OrderType(62);
		// // Unused
		public static final OrderType TrainFighter = new OrderType(63); // Interceptor
																		// /
																		// Scarab
																		// ?
		...
		// public static final OrderType DroneLand = new OrderType(70); //
		// Unused
		...
		/**
		 * Unit is waiting to enter the refinery (another unit is currently in
		 * it)
		 */
		...
		/**
		 * Unit is waiting to use the mineral patch (another unit is currently
		 * mining from it)
		 */
		...
		// public static final OrderType WatchTarget = new OrderType(100); //
		// Unused
		...
		// public static final OrderType InitArbiter = new OrderType(130); //
		// Unused
		...
		// public static final OrderType SapLocation = new OrderType(135); //
		// Unused
		// public static final OrderType SuicideHoldPosition = new
		// OrderType(136); // Unused
		...
		// public static final OrderType InitPsiProvider = new OrderType(164);
		// // Unused
		...
		public static OrderType getOrderType(int id) {
			OrderType type = idToOrderType.get(id);
