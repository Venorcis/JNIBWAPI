 ...
 * http://code.google.com/p/bwapi/wiki/PlayerType
 */
public enum PlayerType {
	//
	None(0), Computer(1), Player(2), RescuePassive(3), Unused_RescueActive(4), EitherPreferComputer(5),
	//
	EitherPreferHuman(6), Neutral(7), Closed(8), Unused_Observer(9), PlayerLeft(10), ComputerLeft(11), Unknown(12);
	//
